...
import edu.unl.qte.core.provider.EventInputHandler;
import edu.unl.qte.core.provider.TypeHandlerPair;
import edu.unl.qte.core.provider.WebEventInputProvider;
import edu.unl.qte.core.util.SeleniumHelper;
import edu.unl.qte.core.extractor.WebEventExtractor;
import edu.unl.qte.core.util.MyWebDriverBackedSelenium;
