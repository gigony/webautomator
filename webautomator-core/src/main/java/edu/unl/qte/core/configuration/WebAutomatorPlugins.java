...
import edu.unl.qte.core.exception.PluginNotFoundException;
...
public final class WebAutomatorPlugins {
  ...
  public static class WebAutomatorPluginsBuilder {
    ...
    private void setDefaultPlugins() {
      this.setPlugin("core.converter.testcase", "edu.unl.qte.core.converter.WebTestCaseConverter");
      this.setPlugin("core.extractor.state", "edu.unl.qte.core.extractor.WebStateExtractor");
      this.setPlugin("core.extractor.event", "edu.unl.qte.core.extractor.WebEventExtractor");
      this.setPlugin("core.provider.eventinput", "edu.unl.qte.core.provider.WebEventInputProvider");
      this.setPlugin("core.executor.event", "edu.unl.qte.core.executor.WebEventExecutor");
      this.setPlugin("core.executor.testcase", "edu.unl.qte.core.executor.WebTestCaseExecutor");
    }
